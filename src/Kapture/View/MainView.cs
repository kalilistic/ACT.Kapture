...
namespace ACT_FFXIV_Kapture.Plugin
{
	public partial class MainView : UserControl
	{
		...
		public bool GeneralGetMarketBoardDataEnabled
		{
			get => generalGetMarketBoardDataCheckBox.Checked;
			set => generalGetMarketBoardDataCheckBox.Checked = value;
		}
		...
		public bool FiltersItemCastLotEnabled
		{
			get => filtersItemCastLotCheckBox.Checked;
			set => filtersItemCastLotCheckBox.Checked = value;
		}
		...
		public bool FiltersItemSearchedEnabled
		{
			get => filtersItemSearchedCheckBox.Checked;
			set => filtersItemSearchedCheckBox.Checked = value;
		}
		...
		public bool FiltersIncludeMountsOnly
		{
			get => filtersIncludeMountsOnlyCheckBox.Checked;
			set => filtersIncludeMountsOnlyCheckBox.Checked = value;
		}
		...
		private void SetupGeneral()
		{
			...
			generalGetMarketBoardDataCheckBox.Text = Strings.GetMarketBoardData;
			...
			generalGetMarketBoardDataCheckBox.CheckedChanged += GeneralGetMarketBoardDataCheckBoxChanged;
		}
		...
		private void SetupFilters()
		{
			...
			filtersItemCastLotCheckBox.Text = Strings.ItemCastLot;
			filtersItemLostCheckBox.Text = Strings.ItemLost;
			filtersItemSearchedCheckBox.Text = Strings.ItemSearched;
			...
			filtersIncludeMountsOnlyCheckBox.Text = Strings.IncludeMounts;
			...
			filtersItemCastLotCheckBox.CheckedChanged += FiltersItemCastLotCheckBoxChanged;
			filtersItemSearchedCheckBox.CheckedChanged += FiltersItemSearchedCheckBoxChanged;
			...
			filtersIncludeMountsOnlyCheckBox.CheckedChanged += FiltersIncludeMountsOnlyCheckBoxChanged;
		...
		public event EventHandler<bool> GeneralGetMarketBoardDataChanged;
		...
		public event EventHandler<bool> FiltersItemCastLotEnabledChanged;
		public event EventHandler<bool> FiltersItemLostEnabledChanged;
		public event EventHandler<bool> FiltersItemSearchedEnabledChanged;
		...
		public event EventHandler<bool> FiltersIncludeMountsOnlyChanged;
		...
		private void GeneralGetMarketBoardDataCheckBoxChanged(object sender, EventArgs e)
		{
			GeneralGetMarketBoardDataChanged?.Invoke(sender, ((CheckBox) sender).Checked);
		}
		...
		private void FiltersItemCastLotCheckBoxChanged(object sender, EventArgs e)
		{
			FiltersItemCastLotEnabledChanged?.Invoke(sender, ((CheckBox) sender).Checked);
		}

		private void FiltersItemSearchedCheckBoxChanged(object sender, EventArgs e)
		{
			FiltersItemSearchedEnabledChanged?.Invoke(sender, ((CheckBox) sender).Checked);
		}
		...
		private void FiltersIncludeMountsOnlyCheckBoxChanged(object sender, EventArgs e)
		{
			FiltersIncludeMountsOnlyChanged?.Invoke(sender, ((CheckBox) sender).Checked);
		}
