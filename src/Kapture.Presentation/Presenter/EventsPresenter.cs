...
namespace ACT_FFXIV_Kapture.Presentation
{
    public class EventsPresenter
    {
        ...
        public EventsPresenter(EventsView eventsView)
        {
            ...
            EventsView.ItemDroppedEnabled = Configuration.Events.ItemDroppedEnabled;
            EventsView.YouObtainedEnabled = Configuration.Events.YouObtainedEnabled;
            EventsView.PartyMemberObtainedEnabled = Configuration.Events.TheyObtainedEnabled;
            EventsView.YouRolledEnabled = Configuration.Events.YouRolledEnabled;
            EventsView.PartyMemberRolledEnabled = Configuration.Events.TheyRolledEnabled;
