...
namespace ACT_FFXIV_Kapture.Presentation
{
    partial class EventsView
    {
        ...
        private void InitializeComponent()
        {
			...
			this.events_ItemLostCheckBox.Size = new System.Drawing.Size(123, 17);
			this.events_ItemLostCheckBox.TabIndex = 3;
			this.events_ItemLostCheckBox.Text = "Item dropped to floor";
			...
			this.events_YouRollCheckBox.Size = new System.Drawing.Size(123, 17);
			this.events_YouRollCheckBox.TabIndex = 11;
			this.events_YouRollCheckBox.Text = "Item dropped to floor";
			...
			this.events_YouObtainCheckBox.Size = new System.Drawing.Size(126, 17);
			this.events_YouObtainCheckBox.TabIndex = 12;
			this.events_YouObtainCheckBox.Text = "You obtained an item";
			...
			this.events_TheyObtainCheckBox.Size = new System.Drawing.Size(131, 17);
			this.events_TheyObtainCheckBox.TabIndex = 14;
			this.events_TheyObtainCheckBox.Text = "They obtained an item";
			...
			this.events_TheyRollCheckBox.Size = new System.Drawing.Size(130, 17);
			this.events_TheyRollCheckBox.TabIndex = 13;
			this.events_TheyRollCheckBox.Text = "They rolled on an item";
